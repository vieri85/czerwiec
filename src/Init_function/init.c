...
void spi_init(void)
{
	...
	cr1_conf.cr1_bits.BIDI_MODE = 1;
	cr1_conf.cr1_bits.BIDI_OE = 1;
	cr1_conf.cr1_bits.CPHA = 1;
	cr1_conf.cr1_bits.CPOL = 1;
	cr1_conf.cr1_bits.CRCL = 1;
	cr1_conf.cr1_bits.CRC_EN = 1;
	cr1_conf.cr1_bits.CRC_NEXT = 1;
	cr1_conf.cr1_bits.LSB_FIRST =1;
	cr1_conf.cr1_bits.MSTR = 1;
	cr1_conf.cr1_bits.RX_ONLY =
	cr1_conf.cr1_bits.BR = 4;  // prescaler: 32
	cr1_conf.cr1_bits.SPE = 0; //Mozliwe ze trza po inicjalizacji pozostalych bitow ustawic i cr2
	...
	cr2_conf.cr2_bits.RXDMA_EN = 1;
	cr2_conf.cr2_bits.TSDMA_EN = 1;
	cr2_conf.cr2_bits.SSO_EN = 1;
	cr2_conf.cr2_bits.NSSP = 1;
	cr2_conf.cr2_bits.FRF = 1; //Motorolla mode ???
	cr2_conf.cr2_bits.ERRIE = 1;
	cr2_conf.cr2_bits.RXNEIE = 1;
	cr2_conf.cr2_bits.TXEIE = 1; // ustaw na 1 gdy interrupt od pustego bufora Tx ma byc
	cr2_conf.cr2_bits.DS = 7; //8bit ramka
	cr2_conf.cr2_bits.FRXTH = 1;
	cr2_conf.cr2_bits.LDMA_RX = 1;
	cr2_conf.cr2_bits.LDMA_TX = 1;
